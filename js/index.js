...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function sec2_height() {
        ...
        document.querySelector(".section2").style.height =
            sec2Height + 100 + "px";
    }
    ...
    let index_scroll = () => {
        ...
        let sec2_txt_wrap_ul =
            document.querySelector(".sec2_txt_wrap ul").offsetTop;
        ...
        sec2_txt_wrap_li.forEach(function (item, index) {
            ...
            if (
                itemTop <= middleOfViewport + item.clientHeight &&
                itemBottom >= middleOfViewport
            ) {
    ...
    function animateV() {
        ...
        scale = scale < 0.2 ? 0.2 : scale > 0.97 ? 1 : scale;
        ...
        // about
        let scale2 = 1 - (bottom - window.innerHeight) * 0.0005;
    ...
    function animateProjects() {
        ...
        let percentage =
            ((index_wrapper.scrollTop - offsetTop) / window.innerHeight) * 270;
        percentage =
            percentage < 0 ? 0 : percentage > limit ? limit : percentage;
